...
public interface ApiTestController {
  ...
  @Operation(summary = "테스트 api", description = "테스트용 API 엔드포인트")
  ResponseEntity<SuccessResponse<Map<String, String>>> getRoot(
      @Parameter(required = false) String key,
      @Parameter(required = false) String value);
