...
public record ApiTaskDto(
        ...
        @NotNull @Schema(description = "요청 헤더") @JsonDeserialize(as = LinkedMultiValueMap.class) MultiValueMap<String, String> reqHeader,
        @NotNull @Schema(description = "요청 바디") @JsonDeserialize(as = HashMap.class) Map<String, Object> reqBody,
        @NotNull @Schema(description = "요청 쿼리 파라미터") @JsonDeserialize(as = LinkedMultiValueMap.class) MultiValueMap<String, String> reqQuery,
        @NotNull @Schema(description = "요청 경로 파라미터") @JsonDeserialize(as = HashMap.class) Map<String, String> reqPath,
        @NotNull @Schema(description = "예상 HTTP stats code. 2: 2XX, 3: 3XX, 4: 4XX, 5: 5XX") Integer statusCode,
        @NotNull @Schema(description = "예상 응답 헤더") @JsonDeserialize(as = LinkedMultiValueMap.class) MultiValueMap<String, String> resHeader,
        @NotNull @Schema(description = "예상 응답 바디") @JsonDeserialize(as = HashMap.class) Map<String, Object> resBody
