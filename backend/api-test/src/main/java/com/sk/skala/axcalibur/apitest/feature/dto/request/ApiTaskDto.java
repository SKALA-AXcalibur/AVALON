...
public record ApiTaskDto(
                ...
                @Nullable @Schema(description = "요청 바디") @JsonDeserialize(as = HashMap.class) Map<String, Object> reqBody,
                ...
                @Nullable @Schema(description = "예상 응답 바디") @JsonDeserialize(as = HashMap.class) Map<String, Object> resBody
