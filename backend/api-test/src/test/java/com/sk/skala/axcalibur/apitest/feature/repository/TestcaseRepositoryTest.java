...
//
//    // when
//    List<TestcaseEntity> result = testcaseRepository.findByMapping_Scenario_ProjectKeyAndMapping_Scenario_ScenarioId(1, "SCENARIO-1");
//
//    // then
...
//    // when
//    List<TestcaseEntity> result = testcaseRepository.findByMapping_Scenario_ProjectKeyAndMapping_Scenario_ScenarioId(0, "NOT_EXIST");
//    // then
//    assertNotNull(result);
