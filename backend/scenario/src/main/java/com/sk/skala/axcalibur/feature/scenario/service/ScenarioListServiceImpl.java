...
public class ScenarioListServiceImpl implements ScenarioListService {
    ...
    public ScenarioListDto getScenarioList(Integer projectKey, int offset, int query) {
        try {
            ...
            log.error("시나리오 목록 조회 실패 - projectKey: {}, offset: {}, query: {}", projectKey, offset, query, e);
            throw new BusinessExceptionHandler("시나리오 목록 조회 실패: " + e.getMessage(), ErrorCode.INTERNAL_SERVER_ERROR);
        }
    }
