...
public interface ApiMappingService {
     ...
     */
    MappingResponseDto doApiMapping(MappingRequestDto request) throws com.fasterxml.jackson.core.JsonProcessingException, com.fasterxml.jackson.databind.JsonMappingException;
